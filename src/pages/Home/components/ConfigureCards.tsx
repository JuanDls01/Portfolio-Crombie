    ...
    >
      <div className='h-full flex flex-row justify-around w-1/2'>
        ...
        <select
          ...
          className='h-10 w-10 flex items-center justify-center bg-transparent focus:outline-none rounded-md focus:border-indigo-500 focus:ring-indigo-500 focus:ring-2'
        >
      ...
      <button
        ...
        className={`h-full w-36 rounded text-white ${

    ...
    <div className='h-12 flex justify-center'>
      ...
      {paginate.pages.map((page, index) => (
        <button
          ...
          className={`h-10 w-10 my-1 mx-2 font-bold flex items-center justify-center rounded transition-colors delay-100 border-[#993399] ${
            page === paginate.currentPage
              ? "bg-[#993399] text-white"
              : "border-2 text-[#993399]"
          }`}
        >
          {page}
        </button>
